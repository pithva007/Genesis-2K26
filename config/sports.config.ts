...
export interface SportConfig {
  ...
  maxMembers: number;
  categories: string[];
  /** Maps category name → total participants allowed (including captain).
   *  Only present on racket/board sports where format determines team size. */
  formatMemberCount?: Record<string, number>;
  fields: FormField[];
  icon: string;
  accent: string;
}
...
const DEPARTMENTS = [
  ...
  "Microbiology", "Medicine", "Surgery", "Obs-Gyne", "Ophthalmology",
  "Pediatrics", "ENT", "Radiology", "Forensic", "Orthopedics", "Psychiatry",
